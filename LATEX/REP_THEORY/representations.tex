...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[node distance=2cm, auto, >=Stealth]
        ...
        % Adjoint World
        \node (vec) [below=1.5cm of spinor] {$X \in \mathfrak{su}(2)$};
...
\begin{fact}
The Adjoint representation is always available for any Lie group. It is the "regulation" way to view a Lie group as a matrix group of rotations on its own algebra.
\end{fact}

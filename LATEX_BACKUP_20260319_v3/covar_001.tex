...
Let $x^\mu$ denote a measurement of the spacetime location of some event in
$X$, in inches, and let ${x'}^{\mu}$ denote a measurement of the spacetime
location of the same event in $X'$, in feet (mnemonic: remember that
\textit{the prime} is in \textit{feet}). Dropping the
index,\sidenote{ironically, or just imagining a 1\nobreakdash-dimensional
setting} one might say $x=12 \times x'$ for any such matched pair of
measurements.

...
(* =========================================================================*)
(* RELATIVITY TOOLKIT PART 1: REGRESSION SUITE*)
(* =========================================================================*)
Print["\n================================================================"];
Print["RUNNING REGRESSION SUITE: THE VECTOR SPACE & METRIC"];
Print["\n================================================================\n"];
...
AssertEqual[expr1_, expr2_, label_] :=
  Module[{c1 = CanonicalizeIndices[expr1], 
    c2 = CanonicalizeIndices[expr2]},
   If[c1 === c2,
    PassCount++;
    Print["[PASS] ", label],
    FailCount++;
...
AssertValence[p[\[ScriptCapitalD][\[Nu]]], {{}, {\[Nu]}}, 
  "Covector p_v"];
AssertValence[
  T[\[ScriptCapitalU][\[Mu]], \[ScriptCapitalD][\[Nu]]], {{\[Mu]}, \
{\[Nu]}}, "Mixed Tensor T^u_v"];
AssertValence[
  T[\[ScriptCapitalD][\[Mu]], \[ScriptCapitalD][\[Nu]]], {{}, {\[Mu], \
\[Nu]}}, "Mixed Tensor T_uv"];
AssertValence[
  T[\[ScriptCapitalU][\[Mu]], \[ScriptCapitalU][\[Nu]]], {{\[Mu], \
\[Nu]}, {}}, "Mixed Tensor T^uv"];
AssertValence[
  T[\[ScriptCapitalD][\[Mu]], \[ScriptCapitalU][\[Nu]]], {{\[Nu]}, \
{\[Mu]}}, "Mixed Tensor T_u^v"];

(*2. Contractions*)
AssertValence[
  x[\[ScriptCapitalU][\[Mu]]]*p[\[ScriptCapitalD][\[Mu]]], {{}, {}}, 
  "Scalar Contraction x^u p_u"];
AssertValence[
  p[\[ScriptCapitalD][\[Mu]]]*x[\[ScriptCapitalU][\[Mu]]], {{}, {}}, 
  "Scalar Contraction p_u x^u"];
AssertValence[
  T[\[ScriptCapitalU][\[Mu]], \[ScriptCapitalD][\[Nu]]]*
   x[\[ScriptCapitalU][\[Nu]]], {{\[Mu]}, {}}, 
  "Tensor-Vector T^u_v x^v -> x^u"];
AssertValence[
  T[\[ScriptCapitalU][\[Mu]], \[ScriptCapitalD][\[Nu]]]*
   x[\[ScriptCapitalD][\[Mu]]], {{}, {\[Nu]}}, 
  "Tensor-Vector T^u_v x_u -> x_n"];

(*3. Arithmetic*)
AssertValence[(x[\[ScriptCapitalU][\[Mu]]]*
     p[\[ScriptCapitalD][\[Mu]]])^2, {{}, {}}, "Power of Scalar"];
AssertValence[5*x[\[ScriptCapitalU][\[Mu]]], {{\[Mu]}, {}}, 
...
AssertEqual[
  P[\[ScriptCapitalU][\[Mu]]]*Q[\[ScriptCapitalD][\[Mu]]]*
   S[\[ScriptCapitalU][\[Nu]]]*T[\[ScriptCapitalD][\[Nu]]],
  S[\[ScriptCapitalU][\[Alpha]]]*T[\[ScriptCapitalD][\[Alpha]]]*
   P[\[ScriptCapitalU][\[Beta]]]*Q[\[ScriptCapitalD][\[Beta]]],
...
(* =========================================================================*)
(* METRIC EQUIVALENCE TEST (The Physicality Check)*)
(* =========================================================================*)
...
(*PROOF STRATEGY:1. Expand A_v->g_va A^a. \
2. Use Hold[] to'freeze' A^a so the metric doesn't immediately re-\
lower it. 3. This forces the metric to lower B instead.*)
